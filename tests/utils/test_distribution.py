...
class TestDistribution:
    ...
    @pytest.fixture
    def fixture_distributions(self) -> None:
        pytest.dist_name = "beta"
        pytest.wrong_name = "Normall"
        pytest.wrong_type = "NumPyy"

    @pytest.fixture
    def fixture_constant_distribution(self) -> None:
        pytest.constant = 10
        pytest.error_message = "Error initializing distribution."

    @pytest.fixture
    def fixture_empirical_distribution(self) -> None:
        pytest.error_message = "Error initializing distribution."
    ...
    @pytest.fixture
    def fixture_numpy_distribution(self) -> None:
        pytest.dist_name = "beta"
        pytest.wrong_name = "Normall"
        pytest.error_message = "Error initializing distribution."
    ...
    def test_empirical_distribution_ValueError_None_data_neither_file(
        self,
        fixture_empirical_distribution
    ):
